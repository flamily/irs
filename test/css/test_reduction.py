...
@pytest.mark.parametrize('raw_results', [
    ...
    ([{'faceId': '8cfb06b4-bbdb-42ca-a78b-962908895704',
        ...
        'faceRectangle': {'top': 191, 'left': 114, 'width': 74, 'height': 74},
        'faceAttributes': {
            'glasses': 'NoGlasses',
            'emotion': {
                'anger': 0.0,
                ...
                'sadness': 0.001,
                'surprise': 0.003}}}, {
        'faceId': 'f19b5217-2094-4d72-9803-b27a2ca8d276',
        'faceRectangle': {'top': 42, 'left': 111, 'width': 74, 'height': 74},
            'faceAttributes': {
                'glasses': 'NoGlasses',
                'emotion': {
                    'anger': 0.825,
                    ...
                    'sadness': 0.103,
                    'surprise': 0.008}}}, {
        'faceId': '46fd15eb-b4df-4186-82b7-d6d0df65a194',
        'faceRectangle': {'top': 193, 'left': 17, 'width': 72, 'height': 72},
            'faceAttributes': {
                'glasses': 'NoGlasses',
                'emotion': {
                    'anger': 0.0,
