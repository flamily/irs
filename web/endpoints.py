...
def get_customer_report(type):
    ...
    res = report.get_customer_satisfaciton(type, date_string)
    labels, data = report.get_chart_data(res)
    avg = report.get_average_score(type, date_string)
...
def get_staff_report(id, date_type):
    ...
    res = report.get_staff_satisfaction_report(id, date_type, date_string)
    labels, data = report.get_chart_data(res)
    avg = report.get_staff_average_score(id, date_type, date_string)
...
def get_menu_score(id, date_type):
    date_string = request.args.get('dateString')
    res = report.get_menu_satisfaction(id, date_type, date_string)
    labels, scores = report.get_chart_data(res)
    avg = report.get_avg_menu_score(id, date_type, date_string)
